    ...
    public function getAdConfig(): array
    {
        ...
        return [
            ...
            'banner' => [
                ...
                'left_rail_slot'            => $s['banner_left_rail_slot'] ?? '',
                'right_rail_slot'           => $s['banner_right_rail_slot'] ?? '',
                'middle_desktop_slot'       => $s['banner_middle_desktop_slot'] ?? '',
                'middle_mobile_slot'        => $s['banner_middle_mobile_slot'] ?? '',
                'sticky_top_mobile_slot'    => $s['banner_sticky_top_mobile_slot'] ?? '',
                'sticky_bottom_mobile_slot' => $s['banner_sticky_bottom_mobile_slot'] ?? '',
                'bottom_top_mobile_slot'    => $s['banner_bottom_top_mobile_slot'] ?? '',
                'bottom_desktop_slot'       => $s['banner_bottom_desktop_slot'] ?? '',
                'bottom_mobile_slot'        => $s['banner_bottom_mobile_slot'] ?? '',
