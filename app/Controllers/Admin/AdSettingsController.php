...
class AdSettingsController extends BaseController
{
    ...
    public function update()
    {
        ...
        $settingKeys = [
            ...
            'banner_left_rail_slot'           => 'trim',
            'banner_right_rail_slot'          => 'trim',
            'banner_middle_desktop_slot'      => 'trim',
            'banner_middle_mobile_slot'       => 'trim',
            'banner_sticky_top_mobile_slot'   => 'trim',
            'banner_sticky_bottom_mobile_slot' => 'trim',
            'banner_bottom_top_mobile_slot'   => 'trim',
            'banner_bottom_desktop_slot'      => 'trim',
            'banner_bottom_mobile_slot'       => 'trim',
